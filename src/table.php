...
$query ="SELECT *FROM users,friendRequest where users.Email=friendRequest.myEmail and friendRequest.myfriendEmail ='$email'";
...
<?php
			...
			echo"<tr>";
			echo "<td>".'<img height="30" width="30" src="data:image;base64,'.$dep['userPic'].'"';
